              ...
              <div className="space-y-2">
                <div className="flex items-center justify-between">
                  ...
                  <Link
                    ...
                    className="text-sm text-blue-600 hover:text-blue-700 transition-colors font-medium outline-none focus-visible:underline"
                  >
                    Forgot password?
                  </Link>
                </div>
      ...
      <div className="hidden lg:flex flex-1 flex-col bg-gradient-to-br from-slate-900 via-blue-950 to-slate-900 relative overflow-hidden">
        ...
        <div className="flex-1 flex flex-col justify-center items-center p-12 relative z-10">
          ...
          <div className="w-full max-w-lg text-white space-y-3 px-2">
            <h2 className="text-3xl font-bold font-sans tracking-tight">Start issuing secure, verifiable certificates in minutes.</h2>
            <p className="text-slate-300 text-lg leading-relaxed">
              CertiDraft provides everything you need to design, bulk-generate, and automatically email professional credentials effortlessly.
            </p>
          </div>
        </div>
      </div>
